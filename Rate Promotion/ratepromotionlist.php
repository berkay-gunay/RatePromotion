                        ...
                        <div class='card-body'>
                            ...
                            <div class='card-body'>
                                <table class='table table-bordered table-striped'>
                                    ...
                                    s.contract_id,s.promo_code,s.booking_period_start,s.booking_period_end,s.travel_date_start,s.travel_date_end,s.days_before,s.min_nights FROM nis_rate_promotion s
                            ...
                            if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['delete_id'])) {
                                ...
                                $deleteSql = "DELETE FROM nis_rate_promotion WHERE id = ?";
